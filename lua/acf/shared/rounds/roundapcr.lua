...
ACF.AmmoBlacklist.APCR = { "MO", "SL", "ACMG", "ACMG" }

local Round = {}

Round.type = "Ammo" --Tells the spawn menu what entity to spawn
Round.name = "Armour Piercing Composite Rigid (APCR)" --Human readable name
Round.model = "models/munitions/round_100mm_shot.mdl" --Shell flight model
Round.desc = "A high-velocity ammo meant to penetrate very thick, flat armor"
Round.netid = 7 --Unique ammotype ID for network transmission
